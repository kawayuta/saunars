...
json.activities_month_saunas_rooms user.activities.where(updated_at: Time.zone.today.beginning_of_month..Time.zone.today.end_of_month).order(id: :DESC).pluck(:sauna_id).map { |id| Sauna.find(id).sauna_rooms }.flatten
